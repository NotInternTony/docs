...
<Card title="Supported Cryptocurrencies & Networks" icon="coins" href="/how-grain-works/supported-cryptocurrencies">
  See which crypto assets and blockchain networks your customers can use to pay.
</Card>

<Card title="Pricing" icon="tag" href="/how-grain-works/pricing">
  Understand Grain's transparent fee structure with no hidden costs.
</Card>
